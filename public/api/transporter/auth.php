<?php
/**
 * Transporter API Authentication Helper
 * Include this file at the top of all transporter API endpoints
 */
...
// Check if user is authenticated and is transporter
...
// Check if transporter has completed profile
