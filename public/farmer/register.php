...
$site_title  = "Farmer Registration | AgroHaat";
...
<section class="pt-80 pb-80">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <h2 class="mb-4 text-center">Farmer Registration</h2>
                ...
                <p class="mt-3 text-center">
                    Already have an account? <a href="<?= $BASE_URL ?>farmer/login.php">Login here</a>
                </p>
            </div>
        </div>
    </div>
